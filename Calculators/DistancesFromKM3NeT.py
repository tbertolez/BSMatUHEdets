...
# to compute the layers crossed by a particle from the horizontal plane, to ARCA (KM3NeT).
...
arca_latitude = 36.10
arca_longitude = 16.06
arca_depth = -3400  # Depth in meters 
...
# Computes a vector in the direction of the particle
...
# Can be obtained at https://download.gebco.net/, choosing wide enough boundaries around ARCA, and downloading the "2D netCDF Grid".
homedir = os.path.realpath(__file__)[:-len('Calculators/DistancesFromKM3NeT.py')]
file_path = homedir+"Data/KM3NeT/gebco_2024_n57.4752_s19.1496_w-14.0995_e42.175.nc"
...
np.savetxt(homedir+"Data/KM3NeT/distances_from_ARCA_user.dat",outdata, fmt = ['%.3f','%.3f','%.5e','%.5e','%.5e'])